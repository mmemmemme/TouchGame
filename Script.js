...
window.onload = function () {
	...
	//ねっこ画像
	const zoyamaImgUrl = "nekko.png";						//game.htmlからの相対パス
	...
	game.onload = function () {					//ロードが終わった後にこの関数が呼び出されるので、この関数内にゲームのプログラムを書こう
		...
		//ぞう山ボタン
		const zoyamaImg = new Sprite(216, 172);				//画像サイズをここに書く。使う予定の画像サイズはプロパティで見ておくこと
